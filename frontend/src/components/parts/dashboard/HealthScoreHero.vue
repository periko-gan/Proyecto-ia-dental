...
<template>
  <div class="flex-1 md:col-span-4 flex justify-around">
    <div class="card bg-primary text-primary-content shadow-xl overflow-hidden group text-left w-full border-0">
      <div
      ...
      <div class="flex items-start justify-between gap-4">
        <div>
          ...
          <p class="text-[10px] text-blue-200 uppercase tracking-widest font-label -mt-2">
            {{ heroLatestAnalysis ? `Actualizado ${heroLastUpdate}` : analysesLoading ? 'Cargando historial' : 'Sin análisis disponible' }}
          </p>
        </div>
