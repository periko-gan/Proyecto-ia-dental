...
<template>
  <main class="">
    <section
      class="flex-1 flex flex-col justify-center items-center p-6 md:p-16 lg:p-24 bg-surface"
    >
          ...
          <div class="grid grid-cols-1 gap-5">
            ...
            <div class="group">
              ...
              <input
                ...
                @input="onEmailInput"
              />
              <p v-if="emailTouched && emailError" class="mt-1 ml-1 text-sm text-error">
                {{ emailError }}
              </p>
            </div>
            <div class="group">
              ...
              <div class="relative">
                ...
                <span
                  ...
                  >{{ passwordVisible ? 'visibility_off' : 'visibility' }}</span
                >
              </div>
              <p v-if="passwordTouched && passwordError" class="mt-1 ml-1 text-sm text-error">
                {{ passwordError }}
              </p>
            </div>
          </div>
