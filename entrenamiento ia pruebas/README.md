...
## Frontend web (radiografia -> detecciones + recuadros)

Se incluye un frontend en `frontend/` para cargar una radiografia dental, correr YOLO con `best.pt` y visualizar:

- tabla de detecciones (clase, confianza y bbox)
- imagen anotada con recuadros
...
Puedes cambiar la ruta del modelo desde la UI si no usas `best.pt` en la raiz del proyecto.
